 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue May 28 10:16:51 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME seguidor
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void seguidor_Outputs_wrapper(const real_T *u1,
			real_T *ILmed);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    real_T *ILmed = (real_T *) ssGetOutputPortRealSignal(S, 0);

    seguidor_Outputs_wrapper(u1, ILmed);
