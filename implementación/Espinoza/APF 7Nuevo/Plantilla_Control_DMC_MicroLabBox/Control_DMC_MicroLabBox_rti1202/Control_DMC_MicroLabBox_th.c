/************************ dSPACE target specific file *************************
   ...
   Include file .\Control_DMC_MicroLabBox_rti1202\Control_DMC_MicroLabBox_th.c :

   Task Configuration file for model : Control_DMC_MicroLabBox

   RTI1202 7.10 (02-May-2018)/2.17
   07-Jun-2019 14:45:59
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\Control_DMC_MicroLabBox_rti1202\Control_DMC_MicroLabBox_th.c is for ST).
# endif
