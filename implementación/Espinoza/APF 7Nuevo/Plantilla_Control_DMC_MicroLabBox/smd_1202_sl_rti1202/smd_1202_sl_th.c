/************************ dSPACE target specific file *************************
   ...
   Include file .\smd_1202_sl_rti1202\smd_1202_sl_th.c :

   Task Configuration file for model : smd_1202_sl

   RTI1202 7.10 (02-May-2018)/2.17
   09-Feb-2019 12:10:57
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\smd_1202_sl_rti1202\smd_1202_sl_th.c is for ST).
# endif
