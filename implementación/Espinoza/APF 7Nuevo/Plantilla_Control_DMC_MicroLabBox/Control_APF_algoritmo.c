 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Fri Jun 07 14:46:56 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Control_APF_algoritmo
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    Control_APF_algoritmo_Outputs_wrapper(in, Sw, io, fc, Vs_alfabeta, IL_alfabeta, PLQL, Icref, ic_km1, bandera);
