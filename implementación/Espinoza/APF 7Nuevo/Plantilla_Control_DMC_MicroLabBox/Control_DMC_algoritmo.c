 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Fri Jun 07 14:43:45 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Control_DMC_algoritmo
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Output Port  3 */
#define OUT_PORT_3_NAME       Vs_alfabeta
...
/* Output Port  4 */
#define OUT_PORT_4_NAME       IL_alfabeta
...
/* Output Port  8 */
#define OUT_PORT_8_NAME       bandera
...
extern void Control_DMC_algoritmo_Outputs_wrapper(const real_T *in,
			real_T *Sw,
			real_T *io,
			real_T *fc,
			real_T *Vs_alfabeta,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    real_T *Sw = (real_T *) ssGetOutputPortRealSignal(S, 0);
    real_T *io = (real_T *) ssGetOutputPortRealSignal(S, 1);
    real_T *fc = (real_T *) ssGetOutputPortRealSignal(S, 2);
    real_T *Vs_alfabeta = (real_T *) ssGetOutputPortRealSignal(S, 3);
    real_T *IL_alfabeta = (real_T *) ssGetOutputPortRealSignal(S, 4);
    real_T *PLQL = (real_T *) ssGetOutputPortRealSignal(S, 5);
    real_T *Icref = (real_T *) ssGetOutputPortRealSignal(S, 6);
    real_T *ic_km1 = (real_T *) ssGetOutputPortRealSignal(S, 7);
    real_T *bandera = (real_T *) ssGetOutputPortRealSignal(S, 8);

    Control_DMC_algoritmo_Outputs_wrapper(in, Sw, io, fc, Vs_alfabeta, IL_alfabeta, PLQL, Icref, ic_km1, bandera);
