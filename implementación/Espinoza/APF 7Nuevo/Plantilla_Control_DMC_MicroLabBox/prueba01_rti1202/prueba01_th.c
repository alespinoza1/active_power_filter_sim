/************************ dSPACE target specific file *************************
   ...
   Include file .\prueba01_rti1202\prueba01_th.c :

   Task Configuration file for model : prueba01

   RTI1202 7.10 (02-May-2018)/2.17
   16-Apr-2019 10:01:02
...
/* ===== List of model tasks and assigned interrupt sources ================
   ...
   Timer Task 1 [1e-06 0] s       : Timer A interrupt
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\prueba01_rti1202\prueba01_th.c is for ST).
# endif
