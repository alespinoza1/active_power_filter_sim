/************************ dSPACE target specific file *************************
   ...
   Include file .\prueba02_rti1202\prueba02_th.c :

   Task Configuration file for model : prueba02

   RTI1202 7.10 (02-May-2018)/2.17
   16-Apr-2019 18:12:30
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\prueba02_rti1202\prueba02_th.c is for ST).
# endif
