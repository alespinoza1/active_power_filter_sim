 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Fri Aug 07 14:25:14 2020
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Control_APF7_algoritmo
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    Control_APF7_algoritmo_Outputs_wrapper(in, SwA, io, SwC, fc, Vs_alfabeta, PLQL, QCQS, ic_km1, Icref, Varfiltro);
