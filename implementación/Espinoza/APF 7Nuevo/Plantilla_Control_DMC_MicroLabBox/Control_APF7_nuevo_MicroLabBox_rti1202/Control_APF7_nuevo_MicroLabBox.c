/*
 * Control_APF7_nuevo_MicroLabBox.c
 *
...
#include "Control_APF7_nuevo_MicroLabBox_trc_ptr.h"
...
B_Control_APF7_nuevo_MicroLab_T Control_APF7_nuevo_MicroLabBo_B;

/* Block states (default storage) */
DW_Control_APF7_nuevo_MicroLa_T Control_APF7_nuevo_MicroLabB_DW;

/* Real-time model */
RT_MODEL_Control_APF7_nuevo_M_T Control_APF7_nuevo_MicroLabB_M_;
RT_MODEL_Control_APF7_nuevo_M_T *const Control_APF7_nuevo_MicroLabB_M =
  &Control_APF7_nuevo_MicroLabB_M_;
...
void Control_APF7_nuevo_MicroLabBox_output(void)
{
   ...
   *  Memory: '<S9>/Memory'
   */
  Control_APF7_nuevo_MicroLabBo_B.Gain =
    Control_APF7_nuevo_MicroLabBo_P.Gain_Gain *
    Control_APF7_nuevo_MicroLabB_DW.Memory_PreviousInput;
   ...
   */
  if (Control_APF7_nuevo_MicroLabB_DW.Memory1_PreviousInput >=
      Control_APF7_nuevo_MicroLabBo_P.Constant_Value) {
    tmp = Control_APF7_nuevo_MicroLabBo_P.Gain1_Gain *
      Control_APF7_nuevo_MicroLabB_DW.Memory1_PreviousInput;
  } else {
    tmp = Control_APF7_nuevo_MicroLabBo_P.Constant1_Value;
  }
   ...
   *  Memory: '<S9>/Memory1'
   */
  Control_APF7_nuevo_MicroLabBo_B.Sum = (tmp +
    Control_APF7_nuevo_MicroLabBo_P.Constant_Value_b) +
    Control_APF7_nuevo_MicroLabB_DW.Memory1_PreviousInput;
  ...
  /* --- [RTI120X, ADC C1] - Channel: 1 --- */
  {
    ...
    AdcCl1AnalogIn_getSingleValue(pRTIAdcC1AnalogIn_Ch_1, readStateFlag, (real_T*)
      &Control_APF7_nuevo_MicroLabBo_B.SFunction1);
  }
   ...
   *  Sum: '<S4>/Sum'
   */
  rtb_Gain = (Control_APF7_nuevo_MicroLabBo_P.Gain9_Gain *
              Control_APF7_nuevo_MicroLabBo_B.SFunction1 -
              Control_APF7_nuevo_MicroLabBo_P.Vsa_offset) *
    -Control_APF7_nuevo_MicroLabBo_P.Ganancia_Vsa;
  ...
  /* --- [RTI120X, ADC C1] - Channel: 2 --- */
  {
    ...
    AdcCl1AnalogIn_getSingleValue(pRTIAdcC1AnalogIn_Ch_2, readStateFlag, (real_T*)
      &Control_APF7_nuevo_MicroLabBo_B.SFunction1_h);
  }
   ...
   *  Sum: '<S4>/Sum1'
   */
  rtb_Gain10 = (Control_APF7_nuevo_MicroLabBo_P.Gain1_Gain_d *
                Control_APF7_nuevo_MicroLabBo_B.SFunction1_h -
                Control_APF7_nuevo_MicroLabBo_P.Vsb_offset) *
    -Control_APF7_nuevo_MicroLabBo_P.Ganancia_Vsb;
  ...
  /* --- [RTI120X, ADC C1] - Channel: 3 --- */
  {
    ...
    AdcCl1AnalogIn_getSingleValue(pRTIAdcC1AnalogIn_Ch_3, readStateFlag, (real_T*)
      &Control_APF7_nuevo_MicroLabBo_B.SFunction1_c);
  }
   ...
   *  Sum: '<S4>/Sum2'
   */
  rtb_Gain11 = (Control_APF7_nuevo_MicroLabBo_P.Gain2_Gain *
                Control_APF7_nuevo_MicroLabBo_B.SFunction1_c -
                Control_APF7_nuevo_MicroLabBo_P.Vsc_offset) *
    -Control_APF7_nuevo_MicroLabBo_P.Ganancia_Vsc;
  ...
  /* --- [RTI120X, ADC C1] - Channel: 9 --- */
  {
    ...
    AdcCl1AnalogIn_getSingleValue(pRTIAdcC1AnalogIn_Ch_9, readStateFlag, (real_T*)
      &Control_APF7_nuevo_MicroLabBo_B.SFunction1_n);
  }
   ...
   *  Gain: '<S4>/Gain3'
   */
  rtb_Sum3 = Control_APF7_nuevo_MicroLabBo_P.Ganancia_Ila *
    Control_APF7_nuevo_MicroLabBo_B.SFunction1_n -
    Control_APF7_nuevo_MicroLabBo_P.Ila_offset;
  ...
  /* --- [RTI120X, ADC C1] - Channel: 10 --- */
  {
    ...
    AdcCl1AnalogIn_getSingleValue(pRTIAdcC1AnalogIn_Ch_10, readStateFlag,
      (real_T*) &Control_APF7_nuevo_MicroLabBo_B.SFunction1_o);
  }
   ...
   *  Gain: '<S4>/Gain4'
   */
  rtb_Sum4 = Control_APF7_nuevo_MicroLabBo_P.Ganancia_Ilb *
    Control_APF7_nuevo_MicroLabBo_B.SFunction1_o -
    Control_APF7_nuevo_MicroLabBo_P.Ilb_offset;
  ...
  /* --- [RTI120X, ADC C1] - Channel: 11 --- */
  {
    ...
    AdcCl1AnalogIn_getSingleValue(pRTIAdcC1AnalogIn_Ch_11, readStateFlag,
      (real_T*) &Control_APF7_nuevo_MicroLabBo_B.SFunction1_f);
  }
   ...
   *  Gain: '<S4>/Gain5'
   */
  rtb_Sum5 = Control_APF7_nuevo_MicroLabBo_P.Ganancia_Ilc *
    Control_APF7_nuevo_MicroLabBo_B.SFunction1_f -
    Control_APF7_nuevo_MicroLabBo_P.Ilc_offset;
  ...
  /* --- [RTI120X, ADC C1] - Channel: 17 --- */
  {
    ...
    AdcCl1AnalogIn_getSingleValue(pRTIAdcC1AnalogIn_Ch_17, readStateFlag,
      (real_T*) &Control_APF7_nuevo_MicroLabBo_B.SFunction1_j);
  }
   ...
   *  Gain: '<S4>/Gain6'
   */
  rtb_Sum6 = Control_APF7_nuevo_MicroLabBo_P.Ganancia_Ica *
    Control_APF7_nuevo_MicroLabBo_B.SFunction1_j -
    Control_APF7_nuevo_MicroLabBo_P.Ica_offset;
  ...
  /* --- [RTI120X, ADC C1] - Channel: 18 --- */
  {
    ...
    AdcCl1AnalogIn_getSingleValue(pRTIAdcC1AnalogIn_Ch_18, readStateFlag,
      (real_T*) &Control_APF7_nuevo_MicroLabBo_B.SFunction1_l);
  }
   ...
   *  Gain: '<S4>/Gain7'
   */
  rtb_Sum7 = Control_APF7_nuevo_MicroLabBo_P.Ganancia_Icb *
    Control_APF7_nuevo_MicroLabBo_B.SFunction1_l -
    Control_APF7_nuevo_MicroLabBo_P.Icb_offset;
  ...
  /* --- [RTI120X, ADC C1] - Channel: 19 --- */
  {
    ...
    AdcCl1AnalogIn_getSingleValue(pRTIAdcC1AnalogIn_Ch_19, readStateFlag,
      (real_T*) &Control_APF7_nuevo_MicroLabBo_B.SFunction1_ng);
  }
   ...
   *  Gain: '<S4>/Gain8'
   */
  rtb_Sum8 = Control_APF7_nuevo_MicroLabBo_P.Ganancia_Icc *
    Control_APF7_nuevo_MicroLabBo_B.SFunction1_ng -
    Control_APF7_nuevo_MicroLabBo_P.Icc_offset;
  ...
  /* --- [RTI120X, ADC C1] - Channel: 4 --- */
  {
    ...
    AdcCl1AnalogIn_getSingleValue(pRTIAdcC1AnalogIn_Ch_4, readStateFlag, (real_T*)
      &Control_APF7_nuevo_MicroLabBo_B.SFunction1_b);
  }

  /* Gain: '<S4>/Gain15' */
  rtb_Gain15 = Control_APF7_nuevo_MicroLabBo_P.Gain15_Gain *
    Control_APF7_nuevo_MicroLabBo_B.SFunction1_b;
  ...
  /* --- [RTI120X, ADC C1] - Channel: 5 --- */
  {
    ...
    AdcCl1AnalogIn_getSingleValue(pRTIAdcC1AnalogIn_Ch_5, readStateFlag, (real_T*)
      &Control_APF7_nuevo_MicroLabBo_B.SFunction1_i);
  }

  /* Gain: '<S4>/Gain17' */
  rtb_Gain17 = Control_APF7_nuevo_MicroLabBo_P.Gain17_Gain *
    Control_APF7_nuevo_MicroLabBo_B.SFunction1_i;
  ...
  /* --- [RTI120X, ADC C1] - Channel: 6 --- */
  {
    ...
    AdcCl1AnalogIn_getSingleValue(pRTIAdcC1AnalogIn_Ch_6, readStateFlag, (real_T*)
      &Control_APF7_nuevo_MicroLabBo_B.SFunction1_jc);
  }

  /* Gain: '<S4>/Gain18' */
  rtb_Gain18 = Control_APF7_nuevo_MicroLabBo_P.Gain18_Gain *
    Control_APF7_nuevo_MicroLabBo_B.SFunction1_jc;
   ...
   */
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtControlado[0] =
    Control_APF7_nuevo_MicroLabBo_P.Ts;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtControlado[1] = rtb_Gain;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtControlado[2] =
    rtb_Gain10;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtControlado[3] =
    rtb_Gain11;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtControlado[4] = rtb_Sum3;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtControlado[5] = rtb_Sum4;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtControlado[6] = rtb_Sum5;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtControlado[7] = rtb_Sum6;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtControlado[8] = rtb_Sum7;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtControlado[9] = rtb_Sum8;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtControlado[10] =
    Control_APF7_nuevo_MicroLabBo_P.Rc;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtControlado[11] =
    Control_APF7_nuevo_MicroLabBo_P.Lc;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtControlado[12] =
    Control_APF7_nuevo_MicroLabBo_P.Vdc;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtControlado[13] =
    rtb_Gain15;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtControlado[14] =
    rtb_Gain17;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtControlado[15] =
    rtb_Gain18;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtControlado[16] =
    Control_APF7_nuevo_MicroLabBo_P.kp;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtControlado[17] =
    Control_APF7_nuevo_MicroLabBo_P.ki;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtControlado[18] =
    Control_APF7_nuevo_MicroLabBo_P.lamda;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtControlado[19] =
    Control_APF7_nuevo_MicroLabBo_P.z;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtControlado[20] =
    Control_APF7_nuevo_MicroLabBo_P.e;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtControlado[21] =
    Control_APF7_nuevo_MicroLabBo_P.g;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtControlado[22] =
    Control_APF7_nuevo_MicroLabBo_P.f;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtControlado[23] =
    Control_APF7_nuevo_MicroLabBo_P.x;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtControlado[24] =
    Control_APF7_nuevo_MicroLabBo_P.y;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtControlado[25] =
    Control_APF7_nuevo_MicroLabBo_P.sat;

  /* S-Function (Control_APF7_algoritmo): '<S1>/Controlador' */
  Control_APF7_algoritmo_Outputs_wrapper
    (&Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtControlado[0],
     &Control_APF7_nuevo_MicroLabBo_B.contador[0],
     &Control_APF7_nuevo_MicroLabBo_B.Controlador_o2[0],
     &Control_APF7_nuevo_MicroLabBo_B.Controlador_o3[0],
     &Control_APF7_nuevo_MicroLabBo_B.Controlador_o4[0],
     &Control_APF7_nuevo_MicroLabBo_B.Controlador_o5[0],
     &Control_APF7_nuevo_MicroLabBo_B.Controlador_o6[0],
     &Control_APF7_nuevo_MicroLabBo_B.Controlador_o7[0],
     &Control_APF7_nuevo_MicroLabBo_B.Controlador_o8[0],
     &Control_APF7_nuevo_MicroLabBo_B.Controlador_o9[0],
     &Control_APF7_nuevo_MicroLabBo_B.Controlador_o10[0]);

  /* S-Function (seguidor_2S): '<S5>/S-Function Builder1' */
  seguidor_2S_Outputs_wrapper(&Control_APF7_nuevo_MicroLabBo_B.Controlador_o6[0],
    &Control_APF7_nuevo_MicroLabBo_B.PLQL[0]);

  /* S-Function (seguidor_2S): '<S6>/S-Function Builder1' */
  seguidor_2S_Outputs_wrapper(&Control_APF7_nuevo_MicroLabBo_B.Controlador_o7[0],
    &Control_APF7_nuevo_MicroLabBo_B.Qc_Qs[0]);
   ...
   *  Sum: '<S45>/Sum'
   */
  Control_APF7_nuevo_MicroLabBo_B.Output = look1_binlxpw(rt_remd_snf
    (Control_APF7_nuevo_MicroLabB_M->Timing.t[0] - (0.0),
     Control_APF7_nuevo_MicroLabBo_P.Constant_Value_g),
    Control_APF7_nuevo_MicroLabBo_P.LookUpTable1_bp01Data,
    Control_APF7_nuevo_MicroLabBo_P.RepeatingSequence1_rep_seq_y, 2U);

  /* RelationalOperator: '<S36>/Relational Operator' */
  rtb_RelationalOperator_b = (Control_APF7_nuevo_MicroLabBo_B.Output <=
    Control_APF7_nuevo_MicroLabBo_B.Controlador_o4[0]);

  /* Gain: '<S36>/Gain1' */
  Control_APF7_nuevo_MicroLabBo_B.Gain1 =
    Control_APF7_nuevo_MicroLabBo_P.Gain1_Gain_f *
    Control_APF7_nuevo_MicroLabBo_B.Controlador_o4[0];

  /* RelationalOperator: '<S36>/Relational Operator2' */
  rtb_RelationalOperator2 = (Control_APF7_nuevo_MicroLabBo_B.Output <=
    Control_APF7_nuevo_MicroLabBo_B.Gain1);

  /* TransportDelay: '<S8>/Transport Delay' */
  {
    real_T **uBuffer = (real_T**)
      &Control_APF7_nuevo_MicroLabB_DW.TransportDelay_PWORK.TUbufferPtrs[0];
    real_T **tBuffer = (real_T**)
      &Control_APF7_nuevo_MicroLabB_DW.TransportDelay_PWORK.TUbufferPtrs[1];
    real_T simTime = Control_APF7_nuevo_MicroLabB_M->Timing.t[0];
    real_T tMinusDelay = simTime - (Control_APF7_nuevo_MicroLabBo_P.Ts *
      0.166667);
    rtb_TransportDelay = rt_TDelayInterpolate(
      ...
      *tBuffer,
      *uBuffer,
      Control_APF7_nuevo_MicroLabB_DW.TransportDelay_IWORK.CircularBufSize,
      &Control_APF7_nuevo_MicroLabB_DW.TransportDelay_IWORK.Last,
      Control_APF7_nuevo_MicroLabB_DW.TransportDelay_IWORK.Tail,
      Control_APF7_nuevo_MicroLabB_DW.TransportDelay_IWORK.Head,
      Control_APF7_nuevo_MicroLabBo_P.TransportDelay_InitOutput,
      0,
      0);
  }
  ...
  /* Gain: '<S37>/Gain1' */
  Control_APF7_nuevo_MicroLabBo_B.Gain1_j =
    Control_APF7_nuevo_MicroLabBo_P.Gain1_Gain_c *
    Control_APF7_nuevo_MicroLabBo_B.Controlador_o4[0];
  ...
  {
    real_T **uBuffer = (real_T**)
      &Control_APF7_nuevo_MicroLabB_DW.TransportDelay1_PWORK.TUbufferPtrs[0];
    real_T **tBuffer = (real_T**)
      &Control_APF7_nuevo_MicroLabB_DW.TransportDelay1_PWORK.TUbufferPtrs[1];
    real_T simTime = Control_APF7_nuevo_MicroLabB_M->Timing.t[0];
    real_T tMinusDelay = simTime - (( Control_APF7_nuevo_MicroLabBo_P.Ts *
      0.333333 ));
    rtb_TransportDelay1 = rt_TDelayInterpolate(
      ...
      *tBuffer,
      *uBuffer,
      Control_APF7_nuevo_MicroLabB_DW.TransportDelay1_IWORK.CircularBufSize,
      &Control_APF7_nuevo_MicroLabB_DW.TransportDelay1_IWORK.Last,
      Control_APF7_nuevo_MicroLabB_DW.TransportDelay1_IWORK.Tail,
      Control_APF7_nuevo_MicroLabB_DW.TransportDelay1_IWORK.Head,
      Control_APF7_nuevo_MicroLabBo_P.TransportDelay1_InitOutput,
      0,
      0);
  }
  ...
  /* Gain: '<S38>/Gain1' */
  Control_APF7_nuevo_MicroLabBo_B.Gain1_m =
    Control_APF7_nuevo_MicroLabBo_P.Gain1_Gain_e *
    Control_APF7_nuevo_MicroLabBo_B.Controlador_o4[0];
   ...
   */
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFunctionB[0] =
    rtb_RelationalOperator_b;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFunctionB[1] =
    rtb_RelationalOperator2;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFunctionB[2] =
    rtb_RelationalOperator_h2;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFunctionB[3] =
    rtb_RelationalOperator2_k;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFunctionB[4] =
    rtb_RelationalOperator_h;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFunctionB[5] =
    rtb_RelationalOperator2_e;

  /* S-Function (seguidor3): '<S46>/S-Function Builder1' */
  seguidor3_Outputs_wrapper
    (&Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFunctionB[0],
     &Control_APF7_nuevo_MicroLabBo_B.Vec_SWA[0]);

  /* RelationalOperator: '<S39>/Relational Operator' */
  rtb_RelationalOperator_d = (Control_APF7_nuevo_MicroLabBo_B.Output <=
    Control_APF7_nuevo_MicroLabBo_B.Controlador_o4[1]);

  /* Gain: '<S39>/Gain1' */
  Control_APF7_nuevo_MicroLabBo_B.Gain1_h =
    Control_APF7_nuevo_MicroLabBo_P.Gain1_Gain_fe *
    Control_APF7_nuevo_MicroLabBo_B.Controlador_o4[1];

  /* RelationalOperator: '<S39>/Relational Operator2' */
  rtb_RelationalOperator2_c = (Control_APF7_nuevo_MicroLabBo_B.Output <=
    Control_APF7_nuevo_MicroLabBo_B.Gain1_h);
  ...
  /* Gain: '<S40>/Gain1' */
  Control_APF7_nuevo_MicroLabBo_B.Gain1_n =
    Control_APF7_nuevo_MicroLabBo_P.Gain1_Gain_h *
    Control_APF7_nuevo_MicroLabBo_B.Controlador_o4[1];
  ...
  /* Gain: '<S41>/Gain1' */
  Control_APF7_nuevo_MicroLabBo_B.Gain1_d =
    Control_APF7_nuevo_MicroLabBo_P.Gain1_Gain_d1 *
    Control_APF7_nuevo_MicroLabBo_B.Controlador_o4[1];
   ...
   */
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFunctio_i[0] =
    rtb_RelationalOperator_d;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFunctio_i[1] =
    rtb_RelationalOperator2_c;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFunctio_i[2] =
    rtb_RelationalOperator_a;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFunctio_i[3] =
    rtb_RelationalOperator2_n;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFunctio_i[4] =
    rtb_RelationalOperator_io;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFunctio_i[5] =
    rtb_RelationalOperator2_i;

  /* S-Function (seguidor3): '<S47>/S-Function Builder1' */
  seguidor3_Outputs_wrapper
    (&Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFunctio_i[0],
     &Control_APF7_nuevo_MicroLabBo_B.Vec_SWB[0]);

  /* RelationalOperator: '<S42>/Relational Operator' */
  rtb_RelationalOperator_jq = (Control_APF7_nuevo_MicroLabBo_B.Output <=
    Control_APF7_nuevo_MicroLabBo_B.Controlador_o4[2]);

  /* Gain: '<S42>/Gain1' */
  Control_APF7_nuevo_MicroLabBo_B.Gain1_f =
    Control_APF7_nuevo_MicroLabBo_P.Gain1_Gain_o *
    Control_APF7_nuevo_MicroLabBo_B.Controlador_o4[2];

  /* RelationalOperator: '<S42>/Relational Operator2' */
  rtb_RelationalOperator2_g = (Control_APF7_nuevo_MicroLabBo_B.Output <=
    Control_APF7_nuevo_MicroLabBo_B.Gain1_f);
  ...
  /* Gain: '<S43>/Gain1' */
  Control_APF7_nuevo_MicroLabBo_B.Gain1_c =
    Control_APF7_nuevo_MicroLabBo_P.Gain1_Gain_g *
    Control_APF7_nuevo_MicroLabBo_B.Controlador_o4[2];
  ...
  /* Gain: '<S44>/Gain1' */
  Control_APF7_nuevo_MicroLabBo_B.Gain1_dv =
    Control_APF7_nuevo_MicroLabBo_P.Gain1_Gain_cv *
    Control_APF7_nuevo_MicroLabBo_B.Controlador_o4[2];
   ...
   */
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFuncti_ig[0] =
    rtb_RelationalOperator_jq;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFuncti_ig[1] =
    rtb_RelationalOperator2_g;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFuncti_ig[2] =
    rtb_RelationalOperator_j;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFuncti_ig[3] =
    rtb_RelationalOperator2_a;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFuncti_ig[4] =
    rtb_RelationalOperator_ko;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFuncti_ig[5] =
    rtb_RelationalOperator2_b;

  /* S-Function (seguidor3): '<S48>/S-Function Builder1' */
  seguidor3_Outputs_wrapper
    (&Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFuncti_ig[0],
     &Control_APF7_nuevo_MicroLabBo_B.Vec_SWC[0]);

  /* Logic: '<S33>/NOT4' incorporates:
   *  DataTypeConversion: '<S38>/Data Type Conversion'
   */
  Control_APF7_nuevo_MicroLabBo_B.NOT4 = !rtb_RelationalOperator_h;
  ...
  /* --- [RTI120X, BITOUT] - Port: 1 - Channel: 11 --- */
  {
    ...
    outputData = ( ( ( (UInt32)Control_APF7_nuevo_MicroLabBo_B.NOT4) << (11 - 1))
                  | outputData);
   ...
   *  DataTypeConversion: '<S38>/Data Type Conversion3'
   */
  Control_APF7_nuevo_MicroLabBo_B.NOT5 = !rtb_RelationalOperator2_e;
  ...
  /* --- [RTI120X, BITOUT] - Port: 1 - Channel: 12 --- */
  {
    ...
    outputData = ( ( ( (UInt32)Control_APF7_nuevo_MicroLabBo_B.NOT5) << (12 - 1))
                  | outputData);
   ...
   *  DataTypeConversion: '<S36>/Data Type Conversion'
   */
  Control_APF7_nuevo_MicroLabBo_B.NOT = !rtb_RelationalOperator_b;
  ...
  /* --- [RTI120X, BITOUT] - Port: 1 - Channel: 15 --- */
  {
    ...
    outputData = ( ( ( (UInt32)Control_APF7_nuevo_MicroLabBo_B.NOT) << (15 - 1))
                  | outputData);
   ...
   *  DataTypeConversion: '<S37>/Data Type Conversion3'
   */
  Control_APF7_nuevo_MicroLabBo_B.NOT3 = !rtb_RelationalOperator2_k;
  ...
  /* --- [RTI120X, BITOUT] - Port: 1 - Channel: 13 --- */
  {
    ...
    outputData = ( ( ( (UInt32)Control_APF7_nuevo_MicroLabBo_B.NOT3) << (13 - 1))
                  | outputData);
   ...
   *  DataTypeConversion: '<S37>/Data Type Conversion'
   */
  Control_APF7_nuevo_MicroLabBo_B.NOT2 = !rtb_RelationalOperator_h2;
  ...
  /* --- [RTI120X, BITOUT] - Port: 1 - Channel: 14 --- */
  {
    ...
    outputData = ( ( ( (UInt32)Control_APF7_nuevo_MicroLabBo_B.NOT2) << (14 - 1))
                  | outputData);
   ...
   *  DataTypeConversion: '<S36>/Data Type Conversion3'
   */
  Control_APF7_nuevo_MicroLabBo_B.NOT1 = !rtb_RelationalOperator2;
  ...
  /* --- [RTI120X, BITOUT] - Port: 1 - Channel: 16 --- */
  {
    ...
    outputData = ( ( ( (UInt32)Control_APF7_nuevo_MicroLabBo_B.NOT1) << (16 - 1))
                  | outputData);
   ...
   *  DataTypeConversion: '<S39>/Data Type Conversion'
   */
  Control_APF7_nuevo_MicroLabBo_B.NOT_h = !rtb_RelationalOperator_d;
  ...
  /* --- [RTI120X, BITOUT] - Port: 1 - Channel: 7 --- */
  {
    ...
    outputData = ( ( ( (UInt32)Control_APF7_nuevo_MicroLabBo_B.NOT_h) << (7 - 1))
                  | outputData);
   ...
   *  DataTypeConversion: '<S41>/Data Type Conversion'
   */
  Control_APF7_nuevo_MicroLabBo_B.NOT4_e = !rtb_RelationalOperator_io;
  ...
  /* --- [RTI120X, BITOUT] - Port: 1 - Channel: 2 --- */
  {
    ...
    outputData = ( ( ( (UInt32)Control_APF7_nuevo_MicroLabBo_B.NOT4_e) << (2 - 1))
                  | outputData);
   ...
   *  DataTypeConversion: '<S41>/Data Type Conversion3'
   */
  Control_APF7_nuevo_MicroLabBo_B.NOT5_a = !rtb_RelationalOperator2_i;
  ...
  /* --- [RTI120X, BITOUT] - Port: 1 - Channel: 3 --- */
  {
    ...
    outputData = ( ( ( (UInt32)Control_APF7_nuevo_MicroLabBo_B.NOT5_a) << (3 - 1))
                  | outputData);
   ...
   *  DataTypeConversion: '<S40>/Data Type Conversion3'
   */
  Control_APF7_nuevo_MicroLabBo_B.NOT3_k = !rtb_RelationalOperator2_n;
  ...
  /* --- [RTI120X, BITOUT] - Port: 1 - Channel: 4 --- */
  {
    ...
    outputData = ( ( ( (UInt32)Control_APF7_nuevo_MicroLabBo_B.NOT3_k) << (4 - 1))
                  | outputData);
   ...
   *  DataTypeConversion: '<S40>/Data Type Conversion'
   */
  Control_APF7_nuevo_MicroLabBo_B.NOT2_i = !rtb_RelationalOperator_a;
  ...
  /* --- [RTI120X, BITOUT] - Port: 1 - Channel: 5 --- */
  {
    ...
    outputData = ( ( ( (UInt32)Control_APF7_nuevo_MicroLabBo_B.NOT2_i) << (5 - 1))
                  | outputData);
   ...
   *  DataTypeConversion: '<S39>/Data Type Conversion3'
   */
  Control_APF7_nuevo_MicroLabBo_B.NOT1_m = !rtb_RelationalOperator2_c;
  ...
  /* --- [RTI120X, BITOUT] - Port: 1 - Channel: 6 --- */
  {
    ...
    outputData = ( ( ( (UInt32)Control_APF7_nuevo_MicroLabBo_B.NOT1_m) << (6 - 1))
                  | outputData);
   ...
   *  DataTypeConversion: '<S42>/Data Type Conversion'
   */
  Control_APF7_nuevo_MicroLabBo_B.NOT_b = !rtb_RelationalOperator_jq;
  ...
  /* --- [RTI120X, BITOUT] - Port: 2 - Channel: 8 --- */
  {
    ...
    outputData = ( ( ( (UInt32)Control_APF7_nuevo_MicroLabBo_B.NOT_b) << (8 - 1))
                  | outputData);
   ...
   *  DataTypeConversion: '<S44>/Data Type Conversion'
   */
  Control_APF7_nuevo_MicroLabBo_B.NOT4_h = !rtb_RelationalOperator_ko;
  ...
  /* --- [RTI120X, BITOUT] - Port: 2 - Channel: 2 --- */
  {
    ...
    outputData = ( ( ( (UInt32)Control_APF7_nuevo_MicroLabBo_B.NOT4_h) << (2 - 1))
                  | outputData);
   ...
   *  DataTypeConversion: '<S44>/Data Type Conversion3'
   */
  Control_APF7_nuevo_MicroLabBo_B.NOT5_p = !rtb_RelationalOperator2_b;
  ...
  /* --- [RTI120X, BITOUT] - Port: 2 - Channel: 4 --- */
  {
    ...
    outputData = ( ( ( (UInt32)Control_APF7_nuevo_MicroLabBo_B.NOT5_p) << (4 - 1))
                  | outputData);
   ...
   *  DataTypeConversion: '<S43>/Data Type Conversion3'
   */
  Control_APF7_nuevo_MicroLabBo_B.NOT3_f = !rtb_RelationalOperator2_a;
  ...
  /* --- [RTI120X, BITOUT] - Port: 2 - Channel: 5 --- */
  {
    ...
    outputData = ( ( ( (UInt32)Control_APF7_nuevo_MicroLabBo_B.NOT3_f) << (5 - 1))
                  | outputData);
   ...
   *  DataTypeConversion: '<S43>/Data Type Conversion'
   */
  Control_APF7_nuevo_MicroLabBo_B.NOT2_b = !rtb_RelationalOperator_j;
  ...
  /* --- [RTI120X, BITOUT] - Port: 2 - Channel: 6 --- */
  {
    ...
    outputData = ( ( ( (UInt32)Control_APF7_nuevo_MicroLabBo_B.NOT2_b) << (6 - 1))
                  | outputData);
   ...
   *  DataTypeConversion: '<S42>/Data Type Conversion3'
   */
  Control_APF7_nuevo_MicroLabBo_B.NOT1_b = !rtb_RelationalOperator2_g;
  ...
  /* --- [RTI120X, BITOUT] - Port: 2 - Channel: 7 --- */
  {
    ...
    outputData = ( ( ( (UInt32)Control_APF7_nuevo_MicroLabBo_B.NOT1_b) << (7 - 1))
                  | outputData);
  ...
  seguidor12_Outputs_wrapper(&Control_APF7_nuevo_MicroLabBo_B.Controlador_o10[0],
    &Control_APF7_nuevo_MicroLabBo_B.varfiltrada[0]);

  /* S-Function (seguidor4): '<S12>/S-Function Builder1' */
  seguidor4_Outputs_wrapper(&Control_APF7_nuevo_MicroLabBo_B.Controlador_o4[0],
    &Control_APF7_nuevo_MicroLabBo_B.fc[0]);

  /* S-Function (seguidor4): '<S13>/S-Function Builder1' */
  seguidor4_Outputs_wrapper(&Control_APF7_nuevo_MicroLabBo_B.Controlador_o8[0],
    &Control_APF7_nuevo_MicroLabBo_B.ickm1[0]);

  /* S-Function (seguidor4): '<S14>/S-Function Builder1' */
  seguidor4_Outputs_wrapper(&Control_APF7_nuevo_MicroLabBo_B.Controlador_o9[0],
    &Control_APF7_nuevo_MicroLabBo_B.icref[0]);

  /* S-Function (seguidor4): '<S15>/S-Function Builder1' */
  seguidor4_Outputs_wrapper(&Control_APF7_nuevo_MicroLabBo_B.Controlador_o2[0],
    &Control_APF7_nuevo_MicroLabBo_B.ploss[0]);

  /* S-Function (seguidor_2S): '<S16>/S-Function Builder1' */
  seguidor_2S_Outputs_wrapper(&Control_APF7_nuevo_MicroLabBo_B.Controlador_o5[0],
    &Control_APF7_nuevo_MicroLabBo_B.vsalfabeta[0]);

  /* SignalConversion: '<S4>/TmpSignal ConversionAtS-Function Builder1Inport1' */
  Control_APF7_nuevo_MicroLabBo_B.Vs_med[0] = rtb_Gain;
  Control_APF7_nuevo_MicroLabBo_B.Vs_med[1] = rtb_Gain10;
  Control_APF7_nuevo_MicroLabBo_B.Vs_med[2] = rtb_Gain11;

  /* S-Function (seguidor): '<S4>/S-Function Builder1' */
  seguidor_Outputs_wrapper(&Control_APF7_nuevo_MicroLabBo_B.Vs_med[0],
    &Control_APF7_nuevo_MicroLabBo_B.Vs_med_j[0]);

  /* SignalConversion: '<S4>/TmpSignal ConversionAtS-Function BuilderInport1' */
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFunctio_f[0] = rtb_Sum3;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFunctio_f[1] = rtb_Sum4;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFunctio_f[2] = rtb_Sum5;

  /* S-Function (seguidor): '<S4>/S-Function Builder' */
  seguidor_Outputs_wrapper
    (&Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFunctio_f[0],
     &Control_APF7_nuevo_MicroLabBo_B.IL_med[0]);

  /* SignalConversion: '<S4>/TmpSignal ConversionAtS-Function Builder2Inport1' */
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFunctio_h[0] = rtb_Sum6;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFunctio_h[1] = rtb_Sum7;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFunctio_h[2] = rtb_Sum8;

  /* S-Function (seguidor): '<S4>/S-Function Builder2' */
  seguidor_Outputs_wrapper
    (&Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFunctio_h[0],
     &Control_APF7_nuevo_MicroLabBo_B.Ic_med[0]);

  /* SignalConversion: '<S4>/TmpSignal ConversionAtS-Function Builder3Inport1' */
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFuncti_iv[0] =
    rtb_Gain15;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFuncti_iv[1] =
    rtb_Gain17;
  Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFuncti_iv[2] =
    rtb_Gain18;

  /* S-Function (seguidor): '<S4>/S-Function Builder3' */
  seguidor_Outputs_wrapper
    (&Control_APF7_nuevo_MicroLabBo_B.TmpSignalConversionAtSFuncti_iv[0],
     &Control_APF7_nuevo_MicroLabBo_B.Vdclink[0]);
  ...
  DioCl1PwmOut_setDutyCycle(pRTIDioC1PwmOut_Port_3_Ch_1, (real_T)
    Control_APF7_nuevo_MicroLabBo_P.DutyCycle_Value);
  DioCl1PwmOut_write(pRTIDioC1PwmOut_Port_3_Ch_1);
}

/* Model update function */
void Control_APF7_nuevo_MicroLabBox_update(void)
{
  ...
  Control_APF7_nuevo_MicroLabB_DW.Memory1_PreviousInput =
    Control_APF7_nuevo_MicroLabBo_B.Sum;
  ...
  /* Update for TransportDelay: '<S8>/Transport Delay' */
  {
    ...
    Control_APF7_nuevo_MicroLabB_DW.TransportDelay_IWORK.Head =
      ((Control_APF7_nuevo_MicroLabB_DW.TransportDelay_IWORK.Head <
        (Control_APF7_nuevo_MicroLabB_DW.TransportDelay_IWORK.CircularBufSize-1))
       ? (Control_APF7_nuevo_MicroLabB_DW.TransportDelay_IWORK.Head+1) : 0);
    if (Control_APF7_nuevo_MicroLabB_DW.TransportDelay_IWORK.Head ==
        Control_APF7_nuevo_MicroLabB_DW.TransportDelay_IWORK.Tail) {
      Control_APF7_nuevo_MicroLabB_DW.TransportDelay_IWORK.Tail =
        ((Control_APF7_nuevo_MicroLabB_DW.TransportDelay_IWORK.Tail <
          (Control_APF7_nuevo_MicroLabB_DW.TransportDelay_IWORK.CircularBufSize-
           1)) ? (Control_APF7_nuevo_MicroLabB_DW.TransportDelay_IWORK.Tail+1) :
         0);
    }

    (*tBuffer)[Control_APF7_nuevo_MicroLabB_DW.TransportDelay_IWORK.Head] =
      simTime;
    (*uBuffer)[Control_APF7_nuevo_MicroLabB_DW.TransportDelay_IWORK.Head] =
      Control_APF7_nuevo_MicroLabBo_B.Output;
  }
  ...
  /* Update for TransportDelay: '<S8>/Transport Delay1' */
  {
    ...
    Control_APF7_nuevo_MicroLabB_DW.TransportDelay1_IWORK.Head =
      ((Control_APF7_nuevo_MicroLabB_DW.TransportDelay1_IWORK.Head <
        (Control_APF7_nuevo_MicroLabB_DW.TransportDelay1_IWORK.CircularBufSize-1))
       ? (Control_APF7_nuevo_MicroLabB_DW.TransportDelay1_IWORK.Head+1) : 0);
    if (Control_APF7_nuevo_MicroLabB_DW.TransportDelay1_IWORK.Head ==
        Control_APF7_nuevo_MicroLabB_DW.TransportDelay1_IWORK.Tail) {
      Control_APF7_nuevo_MicroLabB_DW.TransportDelay1_IWORK.Tail =
        ((Control_APF7_nuevo_MicroLabB_DW.TransportDelay1_IWORK.Tail <
          (Control_APF7_nuevo_MicroLabB_DW.TransportDelay1_IWORK.CircularBufSize
           -1)) ? (Control_APF7_nuevo_MicroLabB_DW.TransportDelay1_IWORK.Tail+1)
         : 0);
    }

    (*tBuffer)[Control_APF7_nuevo_MicroLabB_DW.TransportDelay1_IWORK.Head] =
      simTime;
    (*uBuffer)[Control_APF7_nuevo_MicroLabB_DW.TransportDelay1_IWORK.Head] =
      Control_APF7_nuevo_MicroLabBo_B.Output;
  }
   ...
   */
  if (!(++Control_APF7_nuevo_MicroLabB_M->Timing.clockTick0)) {
    ++Control_APF7_nuevo_MicroLabB_M->Timing.clockTickH0;
  }

  Control_APF7_nuevo_MicroLabB_M->Timing.t[0] =
    Control_APF7_nuevo_MicroLabB_M->Timing.clockTick0 *
    Control_APF7_nuevo_MicroLabB_M->Timing.stepSize0 +
    Control_APF7_nuevo_MicroLabB_M->Timing.clockTickH0 *
    Control_APF7_nuevo_MicroLabB_M->Timing.stepSize0 * 4294967296.0;

  {
     ...
     */
    Control_APF7_nuevo_MicroLabB_M->Timing.clockTick1++;
    if (!Control_APF7_nuevo_MicroLabB_M->Timing.clockTick1) {
      Control_APF7_nuevo_MicroLabB_M->Timing.clockTickH1++;
    }
  }
}

/* Model initialize function */
void Control_APF7_nuevo_MicroLabBox_initialize(void)
{
  /* Registration code */
  ...
  (void) memset((void *)Control_APF7_nuevo_MicroLabB_M, 0,
                sizeof(RT_MODEL_Control_APF7_nuevo_M_T));

  {
    /* Setup solver object */
    rtsiSetSimTimeStepPtr(&Control_APF7_nuevo_MicroLabB_M->solverInfo,
                          &Control_APF7_nuevo_MicroLabB_M->Timing.simTimeStep);
    rtsiSetTPtr(&Control_APF7_nuevo_MicroLabB_M->solverInfo, &rtmGetTPtr
                (Control_APF7_nuevo_MicroLabB_M));
    rtsiSetStepSizePtr(&Control_APF7_nuevo_MicroLabB_M->solverInfo,
                       &Control_APF7_nuevo_MicroLabB_M->Timing.stepSize0);
    rtsiSetErrorStatusPtr(&Control_APF7_nuevo_MicroLabB_M->solverInfo,
                          (&rtmGetErrorStatus(Control_APF7_nuevo_MicroLabB_M)));
    rtsiSetRTModelPtr(&Control_APF7_nuevo_MicroLabB_M->solverInfo,
                      Control_APF7_nuevo_MicroLabB_M);
  }

  rtsiSetSimTimeStep(&Control_APF7_nuevo_MicroLabB_M->solverInfo,
                     MAJOR_TIME_STEP);
  rtsiSetSolverName(&Control_APF7_nuevo_MicroLabB_M->solverInfo,
                    "FixedStepDiscrete");
  rtmSetTPtr(Control_APF7_nuevo_MicroLabB_M,
             &Control_APF7_nuevo_MicroLabB_M->Timing.tArray[0]);
  Control_APF7_nuevo_MicroLabB_M->Timing.stepSize0 = 1.0E-6;

  /* block I/O */
  (void) memset(((void *) &Control_APF7_nuevo_MicroLabBo_B), 0,
                sizeof(B_Control_APF7_nuevo_MicroLab_T));

  /* states (dwork) */
  (void) memset((void *)&Control_APF7_nuevo_MicroLabB_DW, 0,
                sizeof(DW_Control_APF7_nuevo_MicroLa_T));

  /* Initialize DataMapInfo substructure containing ModelMap for C API */
  Control_APF7_nuevo_MicroLabBox_InitializeDataMapInfo();

  {
    /* user code (registration function declaration) */
    /*Initialize global TRC pointers. */
    Control_APF7_nuevo_MicroLabBox_rti_init_trc_pointers();
  }

  /* Start for TransportDelay: '<S8>/Transport Delay' */
  {
    real_T *pBuffer =
      &Control_APF7_nuevo_MicroLabB_DW.TransportDelay_RWORK.TUbufferArea[0];
    Control_APF7_nuevo_MicroLabB_DW.TransportDelay_IWORK.Tail = 0;
    Control_APF7_nuevo_MicroLabB_DW.TransportDelay_IWORK.Head = 0;
    Control_APF7_nuevo_MicroLabB_DW.TransportDelay_IWORK.Last = 0;
    Control_APF7_nuevo_MicroLabB_DW.TransportDelay_IWORK.CircularBufSize = 1024;
    pBuffer[0] = Control_APF7_nuevo_MicroLabBo_P.TransportDelay_InitOutput;
    pBuffer[1024] = Control_APF7_nuevo_MicroLabB_M->Timing.t[0];
    Control_APF7_nuevo_MicroLabB_DW.TransportDelay_PWORK.TUbufferPtrs[0] = (void
      *) &pBuffer[0];
    Control_APF7_nuevo_MicroLabB_DW.TransportDelay_PWORK.TUbufferPtrs[1] = (void
      *) &pBuffer[1024];
  }
  ...
  {
    real_T *pBuffer =
      &Control_APF7_nuevo_MicroLabB_DW.TransportDelay1_RWORK.TUbufferArea[0];
    Control_APF7_nuevo_MicroLabB_DW.TransportDelay1_IWORK.Tail = 0;
    Control_APF7_nuevo_MicroLabB_DW.TransportDelay1_IWORK.Head = 0;
    Control_APF7_nuevo_MicroLabB_DW.TransportDelay1_IWORK.Last = 0;
    Control_APF7_nuevo_MicroLabB_DW.TransportDelay1_IWORK.CircularBufSize = 1024;
    pBuffer[0] = Control_APF7_nuevo_MicroLabBo_P.TransportDelay1_InitOutput;
    pBuffer[1024] = Control_APF7_nuevo_MicroLabB_M->Timing.t[0];
    Control_APF7_nuevo_MicroLabB_DW.TransportDelay1_PWORK.TUbufferPtrs[0] =
      (void *) &pBuffer[0];
    Control_APF7_nuevo_MicroLabB_DW.TransportDelay1_PWORK.TUbufferPtrs[1] =
  ...
  Control_APF7_nuevo_MicroLabB_DW.Memory_PreviousInput =
    Control_APF7_nuevo_MicroLabBo_P.Memory_InitialCondition;

  /* InitializeConditions for Memory: '<S9>/Memory1' */
  Control_APF7_nuevo_MicroLabB_DW.Memory1_PreviousInput =
    Control_APF7_nuevo_MicroLabBo_P.Memory1_InitialCondition;
}

/* Model terminate function */
void Control_APF7_nuevo_MicroLabBox_terminate(void)
{
