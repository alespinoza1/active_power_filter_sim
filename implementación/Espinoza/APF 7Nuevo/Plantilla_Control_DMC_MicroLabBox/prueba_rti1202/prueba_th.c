/************************ dSPACE target specific file *************************
   ...
   Include file .\prueba_rti1202\prueba_th.c :

   Task Configuration file for model : prueba

   RTI1202 7.10 (02-May-2018)/2.17
   16-Apr-2019 10:06:44
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\prueba_rti1202\prueba_th.c is for ST).
# endif
