/************************ dSPACE target specific file *************************
   ...
   Include file .\testMicrolabBox_rti1202\testMicrolabBox_th.c :

   Task Configuration file for model : testMicrolabBox

   RTI1202 7.10 (02-May-2018)/2.17
   15-Mar-2019 15:02:41
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\testMicrolabBox_rti1202\testMicrolabBox_th.c is for ST).
# endif
