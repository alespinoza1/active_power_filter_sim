...
#ifndef RTW_HEADER_Control_APF7_MicroLabBox_h_
#define RTW_HEADER_Control_APF7_MicroLabBox_h_
#include <float.h>
#include <math.h>
#include <string.h>
#include "rtw_modelmap.h"
#ifndef Control_APF7_MicroLabBox_COMMON_INCLUDES_
# define Control_APF7_MicroLabBox_COMMON_INCLUDES_
#include <brtenv.h>
#include <rtkernel.h>
...
#endif                                 /* Control_APF7_MicroLabBox_COMMON_INCLUDES_ */

#include "Control_APF7_MicroLabBox_types.h"
...
} DW_Control_APF7_MicroLabBox_T;

/* Parameters (default storage) */
struct P_Control_APF7_MicroLabBox_T_ {
...
struct tag_RTM_Control_APF7_MicroLab_T {
...
extern P_Control_APF7_MicroLabBox_T Control_APF7_MicroLabBox_P;

/* Block signals (default storage) */
extern B_Control_APF7_MicroLabBox_T Control_APF7_MicroLabBox_B;

/* Block states (default storage) */
extern DW_Control_APF7_MicroLabBox_T Control_APF7_MicroLabBox_DW;

/* Model entry point functions */
extern void Control_APF7_MicroLabBox_initialize(void);
extern void Control_APF7_MicroLabBox_output(void);
extern void Control_APF7_MicroLabBox_update(void);
extern void Control_APF7_MicroLabBox_terminate(void);
...
extern RT_MODEL_Control_APF7_MicroLa_T *const Control_APF7_MicroLabBox_M;
 ...
 *
 * '<Root>' : 'Control_APF7_MicroLabBox'
 * '<S1>'   : 'Control_APF7_MicroLabBox/Controlador'
 * '<S2>'   : 'Control_APF7_MicroLabBox/DIO_CLASS1_HWINT_BL2'
 * '<S3>'   : 'Control_APF7_MicroLabBox/DIO_CLASS1_PWM_BL1'
 * '<S4>'   : 'Control_APF7_MicroLabBox/Mediciones1'
 * '<S5>'   : 'Control_APF7_MicroLabBox/Pl QL '
 * '<S6>'   : 'Control_APF7_MicroLabBox/QcQsfiltrada'
 * '<S7>'   : 'Control_APF7_MicroLabBox/RTI Data'
 * '<S8>'   : 'Control_APF7_MicroLabBox/Subsystem3'
 * '<S9>'   : 'Control_APF7_MicroLabBox/TicTac'
 * '<S10>'  : 'Control_APF7_MicroLabBox/Timer Task Assignment1'
 * '<S11>'  : 'Control_APF7_MicroLabBox/filtros'
 * '<S12>'  : 'Control_APF7_MicroLabBox/funcionCosto '
 * '<S13>'  : 'Control_APF7_MicroLabBox/ic km1 '
 * '<S14>'  : 'Control_APF7_MicroLabBox/ic ref '
 * '<S15>'  : 'Control_APF7_MicroLabBox/ploss'
 * '<S16>'  : 'Control_APF7_MicroLabBox/vs alfa beta '
 * '<S17>'  : 'Control_APF7_MicroLabBox/DIO_CLASS1_HWINT_BL2/Common Hardware Interrupt Interface'
 * '<S18>'  : 'Control_APF7_MicroLabBox/Mediciones1/ILa'
 * '<S19>'  : 'Control_APF7_MicroLabBox/Mediciones1/ILb '
 * '<S20>'  : 'Control_APF7_MicroLabBox/Mediciones1/ILc'
 * '<S21>'  : 'Control_APF7_MicroLabBox/Mediciones1/Ica'
 * '<S22>'  : 'Control_APF7_MicroLabBox/Mediciones1/Icb'
 * '<S23>'  : 'Control_APF7_MicroLabBox/Mediciones1/Icc'
 * '<S24>'  : 'Control_APF7_MicroLabBox/Mediciones1/Vsa'
 * '<S25>'  : 'Control_APF7_MicroLabBox/Mediciones1/Vsb'
 * '<S26>'  : 'Control_APF7_MicroLabBox/Mediciones1/Vsc'
 * '<S27>'  : 'Control_APF7_MicroLabBox/Mediciones1/dclink1'
 * '<S28>'  : 'Control_APF7_MicroLabBox/Mediciones1/dclink2'
 * '<S29>'  : 'Control_APF7_MicroLabBox/Mediciones1/dclink3'
 * '<S30>'  : 'Control_APF7_MicroLabBox/RTI Data/RTI Data Store'
 * '<S31>'  : 'Control_APF7_MicroLabBox/RTI Data/RTI Data Store/RTI Data Store'
 * '<S32>'  : 'Control_APF7_MicroLabBox/RTI Data/RTI Data Store/RTI Data Store/RTI Data Store'
 * '<S33>'  : 'Control_APF7_MicroLabBox/Subsystem3/Inversion   '
 * '<S34>'  : 'Control_APF7_MicroLabBox/Subsystem3/Inversion2'
 * '<S35>'  : 'Control_APF7_MicroLabBox/Subsystem3/Inversion3'
 * '<S36>'  : 'Control_APF7_MicroLabBox/Subsystem3/Modulation block a1'
 * '<S37>'  : 'Control_APF7_MicroLabBox/Subsystem3/Modulation block a2'
 * '<S38>'  : 'Control_APF7_MicroLabBox/Subsystem3/Modulation block a3'
 * '<S39>'  : 'Control_APF7_MicroLabBox/Subsystem3/Modulation block b1'
 * '<S40>'  : 'Control_APF7_MicroLabBox/Subsystem3/Modulation block b2'
 * '<S41>'  : 'Control_APF7_MicroLabBox/Subsystem3/Modulation block b3'
 * '<S42>'  : 'Control_APF7_MicroLabBox/Subsystem3/Modulation block c1'
 * '<S43>'  : 'Control_APF7_MicroLabBox/Subsystem3/Modulation block c2'
 * '<S44>'  : 'Control_APF7_MicroLabBox/Subsystem3/Modulation block c3'
 * '<S45>'  : 'Control_APF7_MicroLabBox/Subsystem3/Repeating Sequence1'
 * '<S46>'  : 'Control_APF7_MicroLabBox/Subsystem3/Subsystem'
 * '<S47>'  : 'Control_APF7_MicroLabBox/Subsystem3/Subsystem1'
 * '<S48>'  : 'Control_APF7_MicroLabBox/Subsystem3/Subsystem2'
 * '<S49>'  : 'Control_APF7_MicroLabBox/Subsystem3/faseA'
 * '<S50>'  : 'Control_APF7_MicroLabBox/Subsystem3/faseB'
 * '<S51>'  : 'Control_APF7_MicroLabBox/Subsystem3/faseC'
 * '<S52>'  : 'Control_APF7_MicroLabBox/Subsystem3/faseA/Señales de Conmutación  APF'
 * '<S53>'  : 'Control_APF7_MicroLabBox/Subsystem3/faseA/Señales de Conmutación  APF1'
 * '<S54>'  : 'Control_APF7_MicroLabBox/Subsystem3/faseA/Señales de Conmutación  APF10'
 * '<S55>'  : 'Control_APF7_MicroLabBox/Subsystem3/faseA/Señales de Conmutación  APF7'
 * '<S56>'  : 'Control_APF7_MicroLabBox/Subsystem3/faseA/Señales de Conmutación  APF8'
 * '<S57>'  : 'Control_APF7_MicroLabBox/Subsystem3/faseA/Señales de Conmutación  APF9'
 * '<S58>'  : 'Control_APF7_MicroLabBox/Subsystem3/faseB/Señales de Conmutación  APF10'
 * '<S59>'  : 'Control_APF7_MicroLabBox/Subsystem3/faseB/Señales de Conmutación  APF2'
 * '<S60>'  : 'Control_APF7_MicroLabBox/Subsystem3/faseB/Señales de Conmutación  APF3'
 * '<S61>'  : 'Control_APF7_MicroLabBox/Subsystem3/faseB/Señales de Conmutación  APF7'
 * '<S62>'  : 'Control_APF7_MicroLabBox/Subsystem3/faseB/Señales de Conmutación  APF8'
 * '<S63>'  : 'Control_APF7_MicroLabBox/Subsystem3/faseB/Señales de Conmutación  APF9'
 * '<S64>'  : 'Control_APF7_MicroLabBox/Subsystem3/faseC/Señales de Conmutación  APF10'
 * '<S65>'  : 'Control_APF7_MicroLabBox/Subsystem3/faseC/Señales de Conmutación  APF4'
 * '<S66>'  : 'Control_APF7_MicroLabBox/Subsystem3/faseC/Señales de Conmutación  APF6'
 * '<S67>'  : 'Control_APF7_MicroLabBox/Subsystem3/faseC/Señales de Conmutación  APF7'
 * '<S68>'  : 'Control_APF7_MicroLabBox/Subsystem3/faseC/Señales de Conmutación  APF8'
 * '<S69>'  : 'Control_APF7_MicroLabBox/Subsystem3/faseC/Señales de Conmutación  APF9'
 * '<S70>'  : 'Control_APF7_MicroLabBox/Timer Task Assignment1/SubSystem'
 */
#endif                                 /* RTW_HEADER_Control_APF7_MicroLabBox_h_ */
