/************************ dSPACE target specific file *************************
   ...
   Include file .\Control_APF7_MicroLabBox_rti1202\Control_APF7_MicroLabBox_th.c :

   Task Configuration file for model : Control_APF7_MicroLabBox

   RTI1202 7.10 (02-May-2018)/2.17
   24-Jul-2020 16:44:50
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\Control_APF7_MicroLabBox_rti1202\Control_APF7_MicroLabBox_th.c is for ST).
# endif
