...
#ifndef RTW_HEADER_control_filtro_dq_mod21_acc_private_h_
#define RTW_HEADER_control_filtro_dq_mod21_acc_private_h_
#include "rtwtypes.h"
...
; real_T control_filtro_dq_mod21_acc_rt_TDelayInterpolate ( real_T
